    ...
    CORS(app, 
         resources={r"/*": {
             "origins": [
                 ...
                 "https://xavierai-m-2.vercel.apphttps://xavierai-m-2.vercel.app",  
             ],
             "methods": ["GET", "POST", "PUT", "DELETE", "OPTIONS","PATCH"],
             "allow_headers": ["Content-Type", "Authorization", "X-CSRFToken","User-ID"],
             "expose_headers": ["Content-Type", "Authorization", "X-CSRFToken"],
...
#     CORS(app, 
#          resources={r"/*": {
#              "origins": ["https://xavierai-m-2.vercel.app"],
#              "methods": ["GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH"],
#              "allow_headers": ["Content-Type", "Authorization", "X-CSRFToken", "User-ID"],
#              "expose_headers": ["Content-Type", "Authorization", "X-CSRFToken"],
#              "supports_credentials": True,
...
#             default_user = User.query.get(4269)
#             if not default_user:
#                 default_user = User(id=4269, username='default_ticket_user', password_hash='default_not_used')
#                 db.session.add(default_user)
#                 db.session.commit()
#                 print("Default user created successfully")
#             else:
